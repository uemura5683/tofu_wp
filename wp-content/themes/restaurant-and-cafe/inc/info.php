...
function restaurant_and_cafe_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'restaurant-and-cafe' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme=restaurant-and-cafe' ) . '" target="_blank">' . __( 'here', 'restaurant-and-cafe' ) . '</a></span><br />';
