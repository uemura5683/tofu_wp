...
class Restaurant_and_Cafe_Popular_Post extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? strip_tags( $instance['title'] ) : esc_html__( 'Popular Posts', 'restaurant-and-cafe' );
                ...
                while( $qry->have_posts() ){
                    ...
                    <li>
                        ...
                        <?php }elseif( ! has_post_thumbnail() && $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php restaurant_and_cafe_get_fallback_svg( 'restaurant-and-cafe-recent-post' ); ?>
                            </a>
                        <?php } ?>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? strip_tags( $new_instance['title'] ) : esc_html__( 'Popular Posts', 'restaurant-and-cafe' );
